...
parser_config.add_argument('-e', dest='encrypted_config', choices=[True, False], const=True, default=True)
...
parser_email.add_argument('-e', dest='encrypted_config', choices=[True, False], const=True, default=True)
...
parser_phone.add_argument('-e', dest='encrypted_config', choices=[True, False], const=True, default=True)
...
parser_social.add_argument('-e', dest='encrypted_config', choices=[True, False], const=True, default=True)
...
parser_scrape.add_argument('-e', dest='encrypted_config', choices=[True, False], const=True, default=True)
...
parser_clean.add_argument('-e', dest='encrypted_config', choices=[True, False], const=True, default=True)
